...
const MarqueeDemo = () => {
    ...
    return (
        <>
            ...
            <div className="overflow-hidden w-full relative max-w-6xl mx-auto" onMouseEnter={() => setStopScroll(true)} onMouseLeave={() => setStopScroll(false)} aria-label="Marquee Demo" role="region">
                <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-r from-white to-transparent" />
                <div className="marquee-inner flex w-fit" style={{ animationPlayState: stopScroll ? "paused" : "running", animationDuration: `${cardData.length * 2.5}s` }}>
                    <div className="flex">
                        {useMemo(() => [...cardData, ...cardData], [cardData]).map((card, index) => (
